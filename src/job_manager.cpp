...
void panda::JobManager<Integer, TagType>::put(const Matrix<Integer> &matrix) const {
   rows.put(matrix, my_vertices, my_vertex_maps);
}

template<typename Integer, typename TagType>
void panda::JobManager<Integer, TagType>::put(const Row<Integer> &row) const {
   rows.put(row, my_vertices, my_vertex_maps);
}
...
template<typename Integer, typename TagType>
panda::JobManager<Integer, TagType>::JobManager(const Names &names_, const int number_of_processors,
                                                const int threads_per_processor)
        :
        communication(),
        rows(names_),
...
template<typename Integer, typename TagType>
panda::JobManager<Integer, TagType>::JobManager(const Names &names_, const int number_of_processors,
                                                const int threads_per_processor, const Vertices<Integer> &vertices,
